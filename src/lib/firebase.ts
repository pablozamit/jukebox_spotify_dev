...
console.warn("Firebase client-side initialization (src/lib/firebase.ts) has been disabled as part of Electron migration.");
console.warn("If any functionality still relies on Firebase client SDK, it will not work.");

const firebaseApp = null;
const auth = null;
const db = null;
const isDbValid = false;
